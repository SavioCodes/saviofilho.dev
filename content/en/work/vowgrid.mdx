...
<SystemDiagram
  title="Trust route"
  subtitle="Propose, simulate, evaluate, approve, execute, receipt"
  footer="The product value is the control layer around the action, not the model demo that produced the action."
>
  <FlowStep
    step="01"
